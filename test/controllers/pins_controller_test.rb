...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { active: @pin.active, description: @pin.description, photo: @pin.photo } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { active: @pin.active, description: @pin.description, photo: @pin.photo } }
